...
class ProductController extends Controller
{
    ...
    public function create(Request $request)
    {
        $this->validate(request(),[
            ...
            'brand'=>'required|in:Small Bouquet,Medium Bouquet,Big Bouquet,Premium Big Bouquet,Custom Buoquet,Bunga Meja,Bunga Papan,Dried Flower,Palm Kering,Hampers,Gift Box Custom',
            'price'=>'required|integer',
            'gender'=>'required|in:Bouquet,Bunga,Gift Box',
            'category'=>'required|in:Standard,Custom',
        ]);
