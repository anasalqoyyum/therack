...
<div class="container p-0">
  ...
  <div class="row">
    <div class="col-12 promowrap">
      ...
      <img class="d-block w-100" src="{{ asset('photo/product-small.jpg') }}" alt="">
    </div>
  </div>
  <!-- GET FIT FROM HOME [E]-->
...
<!-- FEATURED SHOES [S]-->
<h2 class="pt-4 d-flex justify-content-center">BESTSELLER</h2>
...
<!-- ADVANTAGE [S]-->
<h2 class="pt-4 d-flex justify-content-center">OUR PROMISE'S</h2>
<div class="row m-0 pt-4">
