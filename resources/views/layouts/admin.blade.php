...
<head>
    ...
    <title>Dashboard - Rizs Florist</title>
    ...
    <!-- Styles -->
    <link rel="icon" href="{{ URL::asset('photo/logo.png') }}" type="image/x-icon" />
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ route('admin.index') }}">
                    <div class="d-flex">
                        <div><img src="{{ asset('photo/logo.png') }}" style="height:70px;" alt=""></div>
                        {{-- <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">{{ config('app.name', 'Laravel') }}
                    </div> --}}
            </div>
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a href="{{ route('profile.edit',['user'=>Auth::user()->id ]) }}" class="dropdown-item">Edit
                                Profile</a>
                ...
                <div class="col-12 col-md-12 col-lg-2 col-md-2 col-sm-12 pb-2">
                    <div class="card">
                        ...
                        <ul class="list-group">
                            ...
                            <a href="{{ route('admin.show') }}" class="list-group-item admin-navigation">
                                Journal
                            </a>
                        </ul>
                    </div>
